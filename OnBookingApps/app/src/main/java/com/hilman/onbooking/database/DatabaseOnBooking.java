package com.hilman.onbooking.database;
...
public class DatabaseOnBooking extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "onbooking";
    ...
    public DatabaseOnBooking(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_USER + " (" + COL_USERNAME + " VARCHAR(20) PRIMARY KEY, " + COL_PASSWORD +
                " TEXT, " + COL_NAME + " TEXT)");
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_ASAL + " TEXT, " + COL_TUJUAN + " TEXT" + ", " + COL_TANGGAL + " DATE, " + COL_DEWASA + " TEXT, "
                + COL_ANAK + " TEXT)");
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('hilmanb13@gmail.com','hilman','Hilman Bayu Aji');");
    }
