...
import com.hilman.onbooking.adapter.HistoryAdapter;
import com.hilman.onbooking.database.DatabaseOnBooking;
import com.hilman.onbooking.model.HistoryModel;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseOnBooking(this);
    ...
    public void refreshList() {
        ...
        //delete data
        listBook.setOnItemClickListener((adapterView, view, i, l) -> {
